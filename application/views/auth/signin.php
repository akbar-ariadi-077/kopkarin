...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= base_url(); ?>assets/src/assets/css/light/authentication/auth-boxed.css" rel="stylesheet" type="text/css" />
        <link href="<?= base_url(); ?>assets/layouts/horizontal-light-menu/css/dark/plugins.css" rel="stylesheet" type="text/css" />
        <link href="<?= base_url(); ?>assets/src/assets/css/dark/authentication/auth-boxed.css" rel="stylesheet" type="text/css" />
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <div class="form-check form-check-primary form-check-inline">
                                                    <input type="checkbox" class="form-check-input me-3" onclick="myFunction()">
