                            ...
                            <tbody>
                                ...
                                <?php foreach ($m_anggota as $y) : ?>
                                    <tr>
                                        <?php $z += 1; ?>
                                        <td><?= $z; ?></td>
                                        <td><?= $y['nama_anggota']; ?></td>
                                        <td><?= $y['payroll_anggota']; ?></td>
                                        <td><?= $y['nama_dept']; ?></td>
                                        <td align="right"><?= number_format($y['simpok_anggota']); ?></td>
                                        <td align="right"><?= number_format($y['simwa_anggota']); ?></td>
                                        <td><?= $y['nama_bank']; ?></td>
                                        <td><?= $y['rekening_anggota']; ?></td>
                                        <td><?= $y['cabang_bank']; ?></td>
                                        <td>
                                            <span class="badge badge-light-<?= ($y['status_anggota'] == 1) ? 'success' : 'danger' ?> mb-2 me-4">
                                                <b><?= ($y['status_anggota'] == 1) ? 'Active' : 'Inactive'; ?></b>
                                            </span>
                                        </td>
                                        <td>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Masukkan nama lengkap anggota" aria-label="nama" name="nama" value="<?= $y['nama_anggota']; ?>">
                                                                    </div>
                                                                    <!-- <div class="input-group mb-3">
                                                                        <span class="input-group-text">
                                                                            <i data-feather="book-open"></i>
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Masukkan ID Payroll" aria-label="payroll" name="payroll" value="<?= $y['payroll_anggota']; ?>">
                                                                    </div>
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text">
                                                                            <i data-feather="home"></i>
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="number" class="form-control" placeholder="Masukkan jumlah Simpanan Pokok anggota" aria-label="simpok" name="simpok" value="<?= $y['simpok_anggota']; ?>">
                                                                    </div>
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text">
                                                                            <i data-feather="shopping-cart"></i>
                                                                        </span>
                                                                        <input type="number" class="form-control" placeholder="Masukkan jumlah Simpanan Wajib anggota" aria-label="simwa" name="simwa" value="<?= $y['simwa_anggota']; ?>">
                                                                    </div>
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text">
                                                                            <i data-feather="book"></i>
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Masukkan Nomor Rekening anggota" aria-label="rekening" name="rekening" value="<?= $y['rekening_anggota']; ?>">
                                                                    </div>
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text">
                                                                            <i data-feather="map-pin"></i>
                                                                        </span>
                                                                        <input type="text" class="form-control" placeholder="Masukkan Cabang Bank anggota" aria-label="cabang" name="cabang" value="<?= $y['cabang_bank']; ?>">
                                                                    </div>
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text">
