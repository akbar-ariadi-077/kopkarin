                                        ...
                                        <div class="widget-content widget-content-area">
                                            <div class="text-center user-info">
                                                <div class="profile-image mt-4 pe-md-4">
                                                    <div class="img-uploader-content">
                                                        <img src="<?= base_url() . 'assets/src/assets/img/pp/usaha/' . $pass_lama_db['photo_profile']; ?>" width="90" height="90"
                                            ...
                                            <div class="text-center">
                                                ...
                                                <div class="modal fade" id="modalUbahFotoProfile" tabindex="-1" role="dialog" aria-labelledby="modalUbahFotoProfileTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <form method="post" action="<?= base_url() . 'usaha/pp_c/' . $this->session->userdata('iduser'); ?>#data" class="mt-0" enctype="multipart/form-data">
                                                ...
                                                <div class="modal fade" id="modalUbahPassword" tabindex="-1" role="dialog" aria-labelledby="modalUbahPasswordTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <form method="post" action="<?= base_url() . 'usaha/pass_c/' . $this->session->userdata('iduser'); ?>#data" class="mt-0">
                                                                <div class="modal-header">
