...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
            ...
            <br><br>
            <form class="form-control" method="post" action="<?= base_url(); ?>anggota/tabungan_kelola_ajukan">
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                        <div class="widget-content widget-content-area br-8">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <h3 style="text-align: center; font-weight: bold;"><u>PENGAJUAN TABUNGAN</u></h3>
                                </div>
                            </div>
                            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" align="left">
                                            <h4>
                                                <span class="badge badge-light-dark">
                                                    <b>
                                                        <?= ($input_jenis_pengajuan); ?> Tabungan
                                                        <input type="hidden" name="jenis_pengajuan" value="<?= $input_jenis_pengajuan; ?>">
                                                    </b>
                                                </span>
                                            </h4>
                                        </td>
