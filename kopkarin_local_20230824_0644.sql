...
--
-- Host: localhost
-- Generation Time: Aug 24, 2023 at 01:44 AM
...
CREATE TABLE `jabatan_pengurus` (
  ...
  `status_jabatan` tinyint(4) NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
...
CREATE TABLE `jumlah_pinjaman` (
  `id` int(5) NOT NULL,
  `int_pinjaman` bigint(20) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 1, 3, 8, 3000000, 1000000, 0.75, 22500, 3, 0, 'HP', 'Diajukan', '', '2023-08-20 16:00:36', '2023-08-20 16:00:36');
...
CREATE TABLE `pengurus` (
  ...
  `jabatan_pengurus` int(5) DEFAULT NULL,
...
CREATE TABLE `tabungan_ambil` (
  ...
  `jumlah_pengambilan` bigint(20) NOT NULL,
...
CREATE TABLE `tabungan_tambah` (
  ...
  `jumlah_menabung` bigint(20) NOT NULL,
...
CREATE TABLE `usaha_transaksi` (
  `id_usaha_transaksi` bigint(20) NOT NULL,
  `id_usaha_customer` bigint(20) NOT NULL,
  `id_usaha_material` int(11) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `id_anggota` bigint(20) DEFAULT NULL,
  `id_pengurus` int(5) DEFAULT NULL,
  `id_aneka_usaha` bigint(20) DEFAULT NULL,
...
(5, 'yunus', 'sunuy123', 'Pengurus', NULL, 2, NULL, NULL, NULL, 1, '2023-08-03 14:03:57'),
...
--
ALTER TABLE `pengurus`
  MODIFY `id_pengurus` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tahun`
  MODIFY `id_tahun` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `usaha_material`
  MODIFY `id_material` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `usaha_transaksi`
--
ALTER TABLE `usaha_transaksi`
  MODIFY `id_usaha_transaksi` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
