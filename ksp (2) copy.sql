...
--
-- Host: localhost
-- Generation Time: Aug 23, 2023 at 02:45 AM
...
INSERT INTO `usaha_transaksi` (`id_usaha_transaksi`, `id_usaha_customer`, `id_usaha_material`, `jenis_transaksi`, `tanggal_transaksi`, `quantity_transaksi`, `harga_satuan`, `ppn_transaksi`, `jumlah`, `keterangan_transaksi`, `status_transaksi`, `cdt`) VALUES
(1, 1, NULL, 'DP Masuk', '2023-08-02', NULL, NULL, NULL, 50000000, NULL, 1, '2023-08-22 15:11:51');
...
--
ALTER TABLE `usaha_transaksi`
  MODIFY `id_usaha_transaksi` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
