...
--
-- Host: localhost:3306
-- Generation Time: Oct 04, 2023 at 02:05 PM
...
CREATE TABLE `anggota` (
  ...
  `payroll_anggota` bigint NOT NULL,
  `dept_anggota` bigint NOT NULL,
  `simpok_anggota` bigint NOT NULL,
  `simwa_anggota` decimal(10,0) NOT NULL,
  `bank_anggota` bigint NOT NULL,
...
(6, 'Sutaman', '0', 20008117, 26, 100000, 250000, 1, '411 010 71 32', '', 1, '2023-10-04 06:30:34'),
...
CREATE TABLE `angsuran` (
  `id_angsuran` bigint NOT NULL,
  `id_pengajuan` bigint NOT NULL,
  `tahun_angsuran` int NOT NULL,
  `bulan_angsuran` int NOT NULL,
  `tanggal_angsuran` date NOT NULL,
  `metode_bayar` int NOT NULL,
  `payroll_anggota` bigint NOT NULL,
  `angsuran_pokok` bigint NOT NULL,
  `angsuran_bunga` bigint NOT NULL,
...
INSERT INTO `angsuran` (`id_angsuran`, `id_pengajuan`, `tahun_angsuran`, `bulan_angsuran`, `tanggal_angsuran`, `metode_bayar`, `payroll_anggota`, `angsuran_pokok`, `angsuran_bunga`, `angsuran_ke`, `jangka_waktu`, `status_pinjaman`, `input_date_time`, `update_date_time`) VALUES
(1, 1, 3, 1, '2023-01-10', 2, 1, 2000000, 150000, 1, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:27:12'),
(2, 1, 3, 2, '2023-02-10', 2, 1, 2000000, 150000, 2, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52'),
(3, 1, 3, 3, '2023-03-10', 2, 1, 2000000, 150000, 3, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52'),
(4, 1, 3, 4, '2023-04-10', 2, 1, 2000000, 150000, 4, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52'),
(5, 1, 3, 5, '2023-05-10', 2, 1, 2000000, 150000, 5, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52'),
(6, 1, 3, 6, '2023-06-10', 2, 1, 2000000, 150000, 6, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52'),
(7, 1, 3, 7, '2023-07-10', 2, 1, 2000000, 150000, 7, 10, 'Belum Lunas', '2023-08-13 09:57:15', '2023-07-17 11:28:52');
...
CREATE TABLE `configuration` (
  ...
  `bunga_pinjaman_per_tahun` decimal(10,5) DEFAULT NULL,
  `bunga_pinjaman_per_bulan` decimal(10,5) DEFAULT NULL,
  `jasa_tabungan` decimal(10,5) DEFAULT NULL,
  `simpanan_pokok` bigint DEFAULT NULL,
  `simpanan_wajib` bigint DEFAULT NULL,
  `status_config` tinyint(1) DEFAULT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `configuration` (`id_config`, `bunga_pinjaman_per_tahun`, `bunga_pinjaman_per_bulan`, `jasa_tabungan`, `simpanan_pokok`, `simpanan_wajib`, `status_config`, `cdt`) VALUES
(1, 9.00000, 0.75000, NULL, NULL, NULL, 1, '2023-08-13 10:16:03');
...
CREATE TABLE `jabatan_pengurus` (
  ...
  `status_jabatan` tinyint NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
INSERT INTO `jabatan_pengurus` (`id_jabatan`, `nama_jabatan`, `status_jabatan`, `cdt`) VALUES
(1, 'Ketua', 1, '2023-08-03 13:55:45'),
(2, 'Wakil Ketua', 1, '2023-08-03 13:55:45'),
(3, 'Sekretaris', 1, '2023-08-03 13:55:45'),
(4, 'Bendahara', 1, '2023-08-03 13:55:45'),
(5, 'Pengawas', 1, '2023-08-03 13:55:45');
...
INSERT INTO `jangka_waktu` (`id`, `int_jangka`, `status`, `cdt`) VALUES
(1, 1, 1, '2023-08-09 00:14:14'),
(2, 2, 1, '2023-08-09 00:14:14'),
(3, 3, 1, '2023-08-09 00:14:14'),
(4, 4, 1, '2023-08-09 00:14:14'),
(5, 5, 1, '2023-08-09 00:14:14'),
(6, 6, 1, '2023-08-09 00:14:14'),
(7, 7, 1, '2023-08-09 00:14:14'),
(8, 8, 1, '2023-08-09 00:14:14'),
(9, 9, 1, '2023-08-09 00:14:14'),
(10, 10, 1, '2023-08-09 00:14:14'),
(11, 11, 1, '2023-08-09 00:14:14'),
(12, 12, 1, '2023-08-09 00:14:14'),
(13, 13, 1, '2023-08-09 00:14:14'),
(14, 14, 1, '2023-08-09 00:14:14'),
(15, 15, 1, '2023-08-09 00:14:14'),
(16, 16, 1, '2023-08-09 00:14:14'),
(17, 17, 1, '2023-08-09 00:14:14'),
(18, 18, 1, '2023-08-09 00:14:14'),
(19, 19, 1, '2023-08-09 00:14:14'),
(20, 20, 1, '2023-08-09 00:14:14'),
(21, 21, 1, '2023-08-09 00:14:14'),
(22, 22, 1, '2023-08-09 00:14:14'),
(23, 23, 1, '2023-08-09 00:14:14'),
(24, 24, 1, '2023-08-09 00:14:14'),
(25, 25, 1, '2023-08-09 00:14:14'),
(26, 26, 1, '2023-08-09 00:14:14'),
(27, 27, 1, '2023-08-09 00:14:14'),
(28, 28, 1, '2023-08-09 00:14:14'),
(29, 29, 1, '2023-08-09 00:14:14'),
(30, 30, 1, '2023-08-09 00:14:14'),
(31, 31, 1, '2023-08-09 00:14:14'),
(32, 32, 1, '2023-08-09 00:14:14'),
(33, 33, 1, '2023-08-09 00:14:14'),
(34, 34, 1, '2023-08-09 00:14:14'),
(35, 35, 1, '2023-08-09 00:14:14'),
(36, 36, 1, '2023-08-09 00:14:14'),
(37, 37, 1, '2023-08-09 00:14:14'),
(38, 38, 1, '2023-08-09 00:14:14'),
(39, 39, 1, '2023-08-09 00:14:14'),
(40, 40, 1, '2023-08-09 00:14:14'),
(41, 41, 1, '2023-08-09 00:14:14'),
(42, 42, 1, '2023-08-09 00:14:14'),
(43, 43, 1, '2023-08-09 00:14:14'),
(44, 44, 1, '2023-08-09 00:14:14'),
(45, 45, 1, '2023-08-09 00:14:14'),
(46, 46, 1, '2023-08-09 00:14:14'),
(47, 47, 1, '2023-08-09 00:14:14'),
(48, 48, 1, '2023-08-09 00:14:14');

-- --------------------------------------------------------

--
-- Table structure for table `jumlah_pinjaman`
--

CREATE TABLE `jumlah_pinjaman` (
  `id` int NOT NULL,
  `int_pinjaman` bigint NOT NULL,
  `status` tinyint(1) NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `jumlah_pinjaman`
--

INSERT INTO `jumlah_pinjaman` (`id`, `int_pinjaman`, `status`, `cdt`) VALUES
(1, 1000000, 1, '2023-08-08 23:59:59'),
(2, 2000000, 1, '2023-08-08 23:59:59'),
(3, 3000000, 1, '2023-08-08 23:59:59'),
(4, 4000000, 1, '2023-08-08 23:59:59'),
(5, 5000000, 1, '2023-08-08 23:59:59'),
(6, 6000000, 1, '2023-08-08 23:59:59'),
(7, 7000000, 1, '2023-08-08 23:59:59'),
(8, 8000000, 1, '2023-08-08 23:59:59'),
(9, 9000000, 1, '2023-08-08 23:59:59'),
(10, 10000000, 1, '2023-08-08 23:59:59'),
(11, 11000000, 1, '2023-08-08 23:59:59'),
(12, 12000000, 1, '2023-08-08 23:59:59'),
(13, 13000000, 1, '2023-08-08 23:59:59'),
(14, 14000000, 1, '2023-08-08 23:59:59'),
(15, 15000000, 1, '2023-08-08 23:59:59'),
(16, 16000000, 1, '2023-08-08 23:59:59'),
(17, 17000000, 1, '2023-08-08 23:59:59'),
(18, 18000000, 1, '2023-08-08 23:59:59'),
(19, 19000000, 1, '2023-08-08 23:59:59'),
(20, 20000000, 1, '2023-08-08 23:59:59'),
(21, 21000000, 1, '2023-08-08 23:59:59'),
(22, 22000000, 1, '2023-08-08 23:59:59'),
(23, 23000000, 1, '2023-08-08 23:59:59'),
(24, 24000000, 1, '2023-08-08 23:59:59'),
(25, 25000000, 1, '2023-08-08 23:59:59'),
(26, 26000000, 1, '2023-08-08 23:59:59'),
(27, 27000000, 1, '2023-08-08 23:59:59'),
(28, 28000000, 1, '2023-08-08 23:59:59'),
(29, 29000000, 1, '2023-08-08 23:59:59'),
(30, 30000000, 1, '2023-08-08 23:59:59');
...
CREATE TABLE `pengajuan` (
  `id` bigint NOT NULL,
  `payroll_anggota` bigint NOT NULL,
  `tahun_pengajuan` int NOT NULL,
  `bulan_pengajuan` int NOT NULL,
  `jumlah_pinjaman` bigint NOT NULL,
  `angsuran_pokok` float NOT NULL,
  `bunga_pinjaman_persen` float NOT NULL,
  `bunga_pinjaman` bigint NOT NULL,
  `jangka_waktu` int NOT NULL,
  `angsuran_ke` int NOT NULL,
  `status_pinjaman` enum('Diajukan','Disetujui','Ditolak','Belum Lunas','Lunas','Dilunasi') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(2, 1, 3, 8, 3000000, 1000000, 0.75, 22500, 3, 0, 'HP', 'Disetujui', '', '2023-08-20 16:00:36', '2023-09-03 23:58:07');
...
CREATE TABLE `pengurus` (
  ...
  `id_anggota` bigint DEFAULT NULL,
  `status_pengurus` tinyint(1) NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `pengurus` (`id_pengurus`, `nama_pengurus`, `jabatan_pengurus`, `id_anggota`, `status_pengurus`, `cdt`) VALUES
(1, 'Saifuddin', 1, NULL, 1, '2023-08-03 14:03:23'),
(2, 'Yunus', 4, NULL, 1, '2023-08-03 14:03:23');
...
CREATE TABLE `pinjaman_barang` (
  `id_pinjaman` bigint NOT NULL,
  `id_pengajuan` bigint NOT NULL,
  `tahun_pinjaman` int NOT NULL,
  `bulan_pinjaman` int NOT NULL,
...
INSERT INTO `pinjaman_barang` (`id_pinjaman`, `id_pengajuan`, `tahun_pinjaman`, `bulan_pinjaman`, `tanggal_pinjaman`, `metode_bayar`, `payroll_anggota`, `angsuran_pokok`, `angsuran_bunga`, `angsuran_ke`, `jangka_waktu`, `nama_barang`, `status_pinjaman`, `input_date_time`, `update_date_time`) VALUES
(1, 1, 3, 1, '2023-01-11', 2, 1, 120139, 32325, 1, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:01:20'),
(2, 1, 3, 2, '2023-02-11', 2, 1, 120139, 32325, 2, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:02:42'),
(3, 1, 3, 3, '2023-03-11', 2, 1, 120139, 32325, 3, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:02:42'),
(4, 1, 3, 4, '2023-04-11', 2, 1, 120139, 32325, 4, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:02:42'),
(5, 1, 3, 5, '2023-05-11', 2, 1, 120139, 32325, 5, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:02:42'),
(6, 1, 3, 6, '2023-06-11', 2, 1, 120139, 32325, 6, 10, 'Laptop', 'Belum Lunas', '2023-08-13 10:12:44', '2023-08-01 23:02:42');
...
CREATE TABLE `simpok_simwa` (
  `id_simpanan` bigint NOT NULL,
  `tahun_simpanan` int NOT NULL,
  `bulan_simpanan` int NOT NULL,
  `payroll_simpanan` bigint NOT NULL,
...
(28, 3, 1, 6, 'Simpanan Pokok', 'Add', 100000, 1, '2023-10-04 06:35:59'),
(29, 3, 1, 6, 'Simpanan Wajib', 'Add', 250000, 1, '2023-10-04 06:36:02');
...
CREATE TABLE `tabungan` (
  ...
  `tahun_tabungan` int NOT NULL,
  `bulan_tabungan` int NOT NULL,
  `tanggal_tabungan` date NOT NULL,
  `metode_bayar` int NOT NULL,
  `payroll_anggota` bigint NOT NULL,
  `jumlah_tabungan` bigint NOT NULL,
...
--
-- Table structure for table `tabungan_ambil`
--

CREATE TABLE `tabungan_ambil` (
  `id` bigint NOT NULL,
  `id_anggota` bigint NOT NULL,
  `id_tahun` int NOT NULL,
  `id_bulan` int NOT NULL,
  `tanggal_pengambilan` date NOT NULL,
  `jumlah_pengambilan` bigint NOT NULL,
  `status_pengajuan` enum('Diajukan','Disetujui','Ditolak') NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `tabungan_kelola`
--

CREATE TABLE `tabungan_kelola` (
  `id` bigint NOT NULL,
  `id_anggota` bigint NOT NULL,
  `id_tahun` int NOT NULL,
  `id_bulan` int NOT NULL,
  `tanggal_pengajuan` date NOT NULL,
  `jumlah_pengajuan` bigint NOT NULL,
  `jenis_pengajuan` enum('Tambah','Ambil') NOT NULL,
  `sistem_pemotongan` enum('Potong Payroll Gaji','Transfer Nominal Tertentu') NOT NULL,
...
--
-- Dumping data for table `tabungan_kelola`
--

INSERT INTO `tabungan_kelola` (`id`, `id_anggota`, `id_tahun`, `id_bulan`, `tanggal_pengajuan`, `jumlah_pengajuan`, `jenis_pengajuan`, `sistem_pemotongan`, `id_pengurus`, `tanggal_approve`, `status_pengajuan`, `cdt`) VALUES
(1, 1, 3, 9, '2023-09-06', 1500000, 'Tambah', 'Potong Payroll Gaji', NULL, NULL, 'Diajukan', '2023-09-06 00:29:58'),
(2, 1, 3, 9, '2023-09-08', 100000, 'Tambah', 'Potong Payroll Gaji', NULL, NULL, 'Diajukan', '2023-09-08 05:30:55'),
(3, 1, 3, 9, '2023-09-08', 100000, 'Tambah', 'Transfer Nominal Tertentu', NULL, NULL, 'Diajukan', '2023-09-08 06:42:38');

-- --------------------------------------------------------

--
-- Table structure for table `tabungan_tambah`
--

CREATE TABLE `tabungan_tambah` (
  `id` bigint NOT NULL,
  `id_anggota` bigint NOT NULL,
  `id_tahun` int NOT NULL,
  `id_bulan` int NOT NULL,
  `tanggal_menabung` date NOT NULL,
  `jumlah_menabung` bigint NOT NULL,
  `sistem_pemotongan` enum('Potong Payroll Gaji','Transfer Nominal Tertentu') NOT NULL,
  `id_pengurus` int DEFAULT NULL,
  `tanggal_approve` date DEFAULT NULL,
  `status_pengajuan` enum('Diajukan','Disetujui','Ditolak') NOT NULL,
...
(7, 2027, '2027', 1, '2023-08-05 10:33:25');
...
--
-- Table structure for table `usaha_customer`
--

CREATE TABLE `usaha_customer` (
...
--
-- Dumping data for table `usaha_customer`
--

INSERT INTO `usaha_customer` (`id_customer`, `nama_customer`, `status`, `cdt`) VALUES
(1, 'UD. Jaya Abdi (Abah Syaiful)', 1, '2023-08-21 13:01:40'),
(2, 'Zahra Sweetness', 1, '2023-08-21 13:01:40');

-- --------------------------------------------------------

--
-- Table structure for table `usaha_material`
--

CREATE TABLE `usaha_material` (
...
--
-- Dumping data for table `usaha_material`
--

INSERT INTO `usaha_material` (`id_material`, `nama_material`, `status`, `cdt`) VALUES
(1, 'Besi Bekas Loading Dox', 1, '2023-08-22 23:45:22'),
(2, 'BIB Buttercup', 1, '2023-08-22 23:45:22'),
(3, 'Broken Corn', 1, '2023-08-22 23:45:22'),
(4, 'CGF', 1, '2023-08-22 23:45:22'),
(5, 'CGF Non CSL', 1, '2023-08-22 23:45:22'),
(6, 'CGF Off Spec', 1, '2023-08-22 23:45:22'),
(7, 'CGF On Spec', 1, '2023-08-22 23:45:22'),
(8, 'Corn Germ', 1, '2023-08-22 23:45:22'),
(9, 'Corn Germ Off Spec', 1, '2023-08-22 23:45:22'),
(10, 'Jumbo Bag', 1, '2023-08-22 23:45:22'),
(11, 'Jumbo Bag Bekas', 1, '2023-08-22 23:45:22'),
(12, 'Kaos Gathering', 1, '2023-08-22 23:45:22'),
(13, 'Kaos Polo Biru', 1, '2023-08-22 23:45:22'),
(14, 'Kaos Polo Hijau', 1, '2023-08-22 23:45:22'),
(15, 'Pallet Bekas', 1, '2023-08-22 23:45:22'),
(16, 'Tepung Sweepingan', 1, '2023-08-22 23:45:22'),
(17, 'Tepung Sweping', 1, '2023-08-22 23:45:22');

-- --------------------------------------------------------

--
-- Table structure for table `usaha_transaksi`
--

CREATE TABLE `usaha_transaksi` (
  `id_usaha_transaksi` bigint NOT NULL,
  `id_usaha_customer` bigint NOT NULL,
  `id_usaha_material` int DEFAULT NULL,
  `jenis_transaksi` enum('DP Masuk','Penjualan') NOT NULL,
  `tanggal_transaksi` date NOT NULL,
  `quantity_transaksi` decimal(10,2) DEFAULT NULL,
  `harga_satuan` decimal(10,2) DEFAULT NULL,
  `ppn_transaksi` decimal(10,2) DEFAULT NULL,
...
--
-- Dumping data for table `usaha_transaksi`
--

INSERT INTO `usaha_transaksi` (`id_usaha_transaksi`, `id_usaha_customer`, `id_usaha_material`, `jenis_transaksi`, `tanggal_transaksi`, `quantity_transaksi`, `harga_satuan`, `ppn_transaksi`, `jumlah`, `no_polisi`, `keterangan_transaksi`, `status_transaksi`, `cdt`) VALUES
(1, 1, NULL, 'DP Masuk', '2023-02-03', NULL, NULL, NULL, 13992000, NULL, NULL, 1, '2023-08-23 14:48:47'),
(2, 1, 5, 'Penjualan', '2023-02-03', 5360.00, 2409.09, 240.91, 14204000, 'L 9616 AV', 'CGF Off 5 Ton', 1, '2023-08-23 14:51:47'),
(3, 1, 6, 'Penjualan', '2023-02-06', 8060.00, 2409.09, 240.91, 21359000, 'W 9584 NX', 'CGF Off 8.06 Ton', 1, '2023-08-23 14:51:47');
...
CREATE TABLE `user` (
  ...
  `role` enum('Administrator','Pengurus','Anggota','Aneka Usaha') NOT NULL,
  `id_anggota` bigint DEFAULT NULL,
  `id_pengurus` int DEFAULT NULL,
  `id_aneka_usaha` bigint DEFAULT NULL,
  `photo_profile` varchar(100) DEFAULT NULL,
  `photo_size` decimal(10,0) DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
  `cdt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `user` (`id`, `usern`, `passw`, `role`, `id_anggota`, `id_pengurus`, `id_aneka_usaha`, `photo_profile`, `photo_size`, `status`, `cdt`) VALUES
(1, 'akbar', 'rabka123', 'Administrator', NULL, NULL, NULL, NULL, NULL, 1, '2023-08-03 14:01:28'),
(2, 'rafi', 'ifar123', 'Anggota', 1, NULL, NULL, '2_rafi_2023-08-20_21:41:47.jpeg', 334083, 1, '2023-08-20 14:41:47'),
(3, 'franky', 'yknarf123', 'Anggota', 2, NULL, NULL, NULL, NULL, 1, '2023-08-03 14:01:34'),
(4, 'mukri', 'irkum123', 'Anggota', 3, NULL, NULL, NULL, NULL, 1, '2023-08-03 14:01:36'),
(5, 'yunus', 'nuy123', 'Pengurus', NULL, 2, NULL, NULL, NULL, 1, '2023-09-05 00:19:07'),
(6, 'saifudin', 'fias123', 'Pengurus', NULL, 1, NULL, NULL, NULL, 1, '2023-08-03 14:04:01'),
(7, 'syaiful', 'lufia123', 'Aneka Usaha', NULL, NULL, 1, '7_syaiful_2023-08-21_21:54:15.jpeg', 334083, 1, '2023-08-21 14:54:15'),
(8, 'zahra', 'arhaz123', 'Aneka Usaha', NULL, NULL, 2, NULL, NULL, 1, '2023-08-21 13:02:34'),
(9, 'sutaman', 'namatus', 'Anggota', 6, NULL, NULL, NULL, NULL, 1, '2023-10-04 06:13:47');
...
ALTER TABLE `angsuran`
  ...
  ADD KEY `fk_angsuaran_pengajuan` (`id_pengajuan`);
...
--
-- Indexes for table `jumlah_pinjaman`
--
ALTER TABLE `jumlah_pinjaman`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pengurus`
  ...
  ADD KEY `fk_pengurus_anggota` (`id_anggota`),
  ADD KEY `fk_pengurus_jabatan` (`jabatan_pengurus`);
...
ALTER TABLE `pinjaman_barang`
  ...
  ADD KEY `fk_pinjaman_pengajuan` (`id_pengajuan`);
...
--
-- Indexes for table `tabungan_ambil`
--
ALTER TABLE `tabungan_ambil`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tabungan_ambil_anggota` (`id_anggota`),
  ADD KEY `fk_tabungan_ambil_tahun` (`id_tahun`),
  ADD KEY `fk_tabungan_ambil_bulan` (`id_bulan`);

--
-- Indexes for table `tabungan_kelola`
--
ALTER TABLE `tabungan_kelola`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tabungan_kelola_anggota` (`id_anggota`),
  ADD KEY `fk_tabungan_kelola_bulan` (`id_bulan`),
  ADD KEY `fk_tabungan_kelola_tahun` (`id_tahun`);

--
-- Indexes for table `tabungan_tambah`
--
ALTER TABLE `tabungan_tambah`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tabungan_tambah_anggota` (`id_anggota`),
  ADD KEY `fk_tabungan_tambah_tahun` (`id_tahun`),
  ADD KEY `fk_tabungan_tambah_bulan` (`id_bulan`);
...
--
-- Indexes for table `usaha_customer`
--
ALTER TABLE `usaha_customer`
  ADD PRIMARY KEY (`id_customer`);

--
-- Indexes for table `usaha_material`
--
ALTER TABLE `usaha_material`
  ADD PRIMARY KEY (`id_material`);

--
-- Indexes for table `usaha_transaksi`
--
ALTER TABLE `usaha_transaksi`
  ADD PRIMARY KEY (`id_usaha_transaksi`),
  ADD KEY `fk_usaha_customer` (`id_usaha_customer`),
  ADD KEY `fk_usaha_material` (`id_usaha_material`);
...
ALTER TABLE `user`
  ...
  ADD KEY `fk_user_pengurus` (`id_pengurus`),
  ADD KEY `fk_user_usaha` (`id_aneka_usaha`);
...
--
ALTER TABLE `anggota`
  MODIFY `id_anggota` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;

--
-- AUTO_INCREMENT for table `angsuran`
--
ALTER TABLE `angsuran`
  MODIFY `id_angsuran` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `bank`
--
ALTER TABLE `bank`
  MODIFY `id_bank` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `configuration`
  MODIFY `id_config` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `department`
--
ALTER TABLE `department`
  MODIFY `id_dept` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
-- AUTO_INCREMENT for table `jumlah_pinjaman`
--
ALTER TABLE `jumlah_pinjaman`
...
--
ALTER TABLE `metode_bayar`
  MODIFY `id_paytod` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pengurus`
  MODIFY `id_pengurus` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pinjaman_barang`
--
ALTER TABLE `pinjaman_barang`
  MODIFY `id_pinjaman` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `simpok_simwa`
--
ALTER TABLE `simpok_simwa`
  MODIFY `id_simpanan` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tabungan`
--
ALTER TABLE `tabungan`
  MODIFY `id_tabungan` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tabungan_ambil`
--
ALTER TABLE `tabungan_ambil`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tabungan_kelola`
--
ALTER TABLE `tabungan_kelola`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tabungan_tambah`
--
ALTER TABLE `tabungan_tambah`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102543;

--
-- AUTO_INCREMENT for table `usaha_customer`
--
ALTER TABLE `usaha_customer`
  MODIFY `id_customer` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `usaha_material`
--
ALTER TABLE `usaha_material`
  MODIFY `id_material` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `usaha_transaksi`
--
ALTER TABLE `usaha_transaksi`
  MODIFY `id_usaha_transaksi` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `angsuran`
  ADD CONSTRAINT `fk_angsuaran_pengajuan` FOREIGN KEY (`id_pengajuan`) REFERENCES `pengajuan` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `pengurus`
  ADD CONSTRAINT `fk_pengurus_anggota` FOREIGN KEY (`id_anggota`) REFERENCES `anggota` (`id_anggota`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pengurus_jabatan` FOREIGN KEY (`jabatan_pengurus`) REFERENCES `jabatan_pengurus` (`id_jabatan`) ON UPDATE CASCADE;
...
ALTER TABLE `pinjaman_barang`
  ...
  ADD CONSTRAINT `fk_pinjaman_pengajuan` FOREIGN KEY (`id_pengajuan`) REFERENCES `pengajuan_barang` (`id`) ON UPDATE CASCADE,
...
--
-- Constraints for table `tabungan_ambil`
--
ALTER TABLE `tabungan_ambil`
  ADD CONSTRAINT `fk_tabungan_ambil_anggota` FOREIGN KEY (`id_anggota`) REFERENCES `anggota` (`id_anggota`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_ambil_bulan` FOREIGN KEY (`id_bulan`) REFERENCES `bulan` (`id_bulan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_ambil_tahun` FOREIGN KEY (`id_tahun`) REFERENCES `tahun` (`id_tahun`) ON UPDATE CASCADE;

--
-- Constraints for table `tabungan_kelola`
--
ALTER TABLE `tabungan_kelola`
  ADD CONSTRAINT `fk_tabungan_kelola_anggota` FOREIGN KEY (`id_anggota`) REFERENCES `anggota` (`id_anggota`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_kelola_bulan` FOREIGN KEY (`id_bulan`) REFERENCES `bulan` (`id_bulan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_kelola_tahun` FOREIGN KEY (`id_tahun`) REFERENCES `tahun` (`id_tahun`) ON UPDATE CASCADE;

--
-- Constraints for table `tabungan_tambah`
--
ALTER TABLE `tabungan_tambah`
  ADD CONSTRAINT `fk_tabungan_tambah_anggota` FOREIGN KEY (`id_anggota`) REFERENCES `anggota` (`id_anggota`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_tambah_bulan` FOREIGN KEY (`id_bulan`) REFERENCES `bulan` (`id_bulan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_tabungan_tambah_tahun` FOREIGN KEY (`id_tahun`) REFERENCES `tahun` (`id_tahun`) ON UPDATE CASCADE;
...
--
-- Constraints for table `usaha_transaksi`
--
ALTER TABLE `usaha_transaksi`
  ADD CONSTRAINT `fk_usaha_customer` FOREIGN KEY (`id_usaha_customer`) REFERENCES `usaha_customer` (`id_customer`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usaha_material` FOREIGN KEY (`id_usaha_material`) REFERENCES `usaha_material` (`id_material`) ON UPDATE CASCADE;
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `fk_user_pengurus` FOREIGN KEY (`id_pengurus`) REFERENCES `pengurus` (`id_pengurus`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_user_usaha` FOREIGN KEY (`id_aneka_usaha`) REFERENCES `usaha_customer` (`id_customer`) ON UPDATE CASCADE;
COMMIT;
